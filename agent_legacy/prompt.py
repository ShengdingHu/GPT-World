...
QA_PROMPT = """You are now an assitant who are able to answer my QUESTION.
You now have access to the following API functions: 
{tool_names_and_descriptions}
Use the following format:
Thought: you should always think about what to do
...
Observation: the result of the action
... (this Thought/Action/Action Input/Observation can repeat N times)
Thought: I think i now know tthe final answer.
Final Answer: xxxxx (Use exactly "Final Answer: ")

Begin! My QUESTION is: {task}
{agent_playground}
"""
